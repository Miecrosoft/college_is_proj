...
global $postberita,$upload_proposal,$msg;
...
if(isset($_POST['subnews'])){
  ...
  $judul_get = $_POST['judul'];
  $judul_strip = stripslashes($judul_get);
  $judul = mysql_real_escape_string($judul_strip);

  $berita_get = $_POST['berita'];
  $berita_strip = stripslashes($berita_get);
  $berita = mysql_real_escape_string($berita_get);

  $query = mysql_query("UPDATE news SET judul = '$judul', berita = '$berita' WHERE id = '$LinkID' ");
  if($query){
	$msg = "Your news has been edited !";
  }
}
?>
<!DOCTYPE html>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="/postberita"><i class="fa fa-newspaper-o"></i><span>Post Berita</span></a></li>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Post Berita
                <small>Write your news by using this tools</small>
              </h3>
            ...
            <?php
            $getquery = mysql_query("SELECT * FROM news WHERE id = '$LinkID' ");
            $getdat = mysql_fetch_assoc($getquery);
            ?>
            <form role="form"  method="POST" enctype="multipart/form-data">
              <div class="box-body">
            	<div class="form-group">
                  <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Proposal" value="<?php echo $getdat['judul']; ?>" required />
                </div>
                <div class="form-group">
                  <textarea id="berita" name="berita" rows="10" cols="10"><?php echo $getdat['berita']; ?></textarea>
                </div>
              </div>
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary" name="subnews">Submit</button>
              </div>
            </form>
          </div>
        </div>
