...
if(isset($_POST['subnews'])){
  ...
  $lab = $_SESSION['lab'];
  $tgl_post = date('d/m/Y H:i');

  $query = mysql_query("INSERT INTO news (id,judul,lab,berita,tgl_post) VALUES ('$id','$judul','$lab','$berita','$tgl_post')");
  if($query){
	$msg = "Your news has been posted !";
  }
}
?>
<!DOCTYPE html>
            ...
            <form role="form"  method="POST" enctype="multipart/form-data">
              <div class="box-body">
            	<div class="form-group">
                  <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Berita" value="<?php echo isset($_POST['judul']) ? $_POST['judul'] : '' ?>" required />
                </div>
                <div class="form-group">
                  <textarea id="berita" name="berita" rows="10" cols="10"></textarea>
                </div>
              </div>
