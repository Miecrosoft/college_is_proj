...
if(isset($_POST['inv'])){
  ...
  mysql_query("INSERT INTO inventaris (id,lab,inven,status) VALUES ('$id','$lab','$barang','$status')");
  $msg = "Data Saved !";
}
?>
<!DOCTYPE html>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="/postinventaris"><i class="fa fa-newspaper-o"></i><span>Input Inventaris</span></a></li>
            ...
            <form role="form"  method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="judul" name="barang" placeholder="Barang Inventaris" value="<?php echo isset($_POST['barang']) ? $_POST['barang'] : '' ?>">
                </div>
                <div class="form-group">
