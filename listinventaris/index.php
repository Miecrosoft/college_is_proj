  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="/listinventaris"><i class="fa fa-table"></i><span>List Inventaris</span></a></li>
        <li class="treeview">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Tabel Inventaris</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  if($_SESSION['admin'] == 1 AND $_SESSION['kordas'] == 0){
                    ...
                    $lab = $_SESSION['lab'];
                    $query = mysql_query("SELECT * FROM inventaris WHERE lab='$lab'");
                  }
                  while($getdat = mysql_fetch_assoc($query)){
                  	if($getdat['status'] == 1){
                  		$status = '<span class="label label-success">Baik</span>';
                  	}elseif($getdat['status'] == 2){
                  		$status = '<span class="label label-danger">Buruk</span>';
                    }
                ?>
                <tr>
                  <td><a><?php echo $getdat['inven']; ?></a></td>
                  <td><?php echo $getdat['lab']; ?></td>
                  <td><?php echo $status; ?></td>
                  <td><a href="/editinventaris/<?php echo $getdat['id']; ?>">Edit</a>  |  <a href="/deleteinventaris/<?php echo $getdat['id']; ?>">Delete</a></td>
                </tr>
                <?php
                }
                ?>
