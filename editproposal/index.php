...
if(isset($_POST['savepro'])){
  ...
  if(empty($ext)){
    mysql_query("UPDATE proposal SET judul = '$judul' WHERE id = '$LinkID' ");
    $msg = "File Saved !";
  }else{
    if($size > 1048576){
      ...
      mysql_query("UPDATE proposal SET judul = '$judul', filepro = '$newname' WHERE id = '$LinkID' ");
      $msg = "File Saved !";
    }
  }
}
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/uploadproposal"><i class="fa fa-file"></i><span>Upload Proposal</span></a></li>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            <?php
              $result = mysql_query("SELECT * FROM proposal WHERE id = '$LinkID' ");
              $getdat = mysql_fetch_assoc($result);
            ?>
            <form role="form"  method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="judul">Judul Proposal</label>
                  <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Proposal" value="<?php echo $getdat['judul']; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group has-error">
                  <label class="help-block">Re-upload file if you wanna change your file. Old file will be replaced.</label>
                </div>
                <div class="form-group has-warning">
                  <label class="help-block">File extention must be in PDF Format MAX 1 MB - For Testing)</label>
                </div>
              </div>
