            ...
            <form role="form"  method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Proposal" value="<?php echo isset($_POST['judul']) ? $_POST['judul'] : '' ?>">
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary" name="subpro">Submit</button>
              </div>
            </form>
          </div>
        </div>
