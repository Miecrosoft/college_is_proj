  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="/listberita"><i class="fa fa-table"></i><span>List Berita</span></a></li>
        <li class="treeview">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  if($_SESSION['admin'] == 1 AND $_SESSION['kordas'] == 0){
                    ...
                    $lab = $_SESSION['lab'];
                    $query = mysql_query("SELECT * FROM news WHERE lab='$lab'");
                  }
                  while($getdat = mysql_fetch_assoc($query)){
                ?>
                <tr>
                  <td><a href="/viewberita/<?php echo $getdat['id']; ?>" target="_blank" ><?php echo $getdat['judul']; ?></a></td>
                  <td><?php echo $getdat['lab']; ?></td>
                  <td><?php echo $getdat['tgl_post'] ?></td>
                  <td><a href="/editberita/<?php echo $getdat['id']; ?>">Edit</a>  |  <a href="/deleteberita/<?php echo $getdat['id']; ?>">Delete</a></td>
                </tr>
                <?php
                }
                ?>
